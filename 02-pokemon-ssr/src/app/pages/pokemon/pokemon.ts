...
export class Pokemon implements OnInit{
  ...
  ngOnInit(): void {
    this.pokemonSvc.loadPokemonById(this.idPokemon()!)
    .pipe(
      tap(pokemon => {
        ...
        this.meta.updateTag({ name: 'og:image', content: `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/${pokemon.id}.svg` });
